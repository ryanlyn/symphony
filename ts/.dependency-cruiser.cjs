 ...
 *   sdk         packages/{tracker,tool,agent,box}-sdk - leaf only
...
const SDK = "packages/(?:tracker-sdk|tool-sdk|agent-sdk|box-sdk)/";
...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      severity: "error",
      from: { path: "^(packages/(?:tracker-sdk|tool-sdk|agent-sdk|box-sdk))/" },
