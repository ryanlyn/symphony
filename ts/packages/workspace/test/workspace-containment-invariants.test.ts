...
describe("INVARIANT: When a workspace path is resolved, it SHALL be a strict descendant of the workspace root.", () => {
...
describe("INVARIANT: When directory names are derived from identifiers, they SHALL contain only alphanumeric characters, dots, hyphens, and underscores", () => {
...
describe("INVARIANT: When sanitization is applied to a name, applying it again SHALL produce the same result.", () => {
...
describe("INVARIANT: When a multi-slot ensemble is resolved, each slot SHALL receive a distinct workspace path.", () => {
...
describe("INVARIANT: When a single-slot run is resolved, the workspace path SHALL have no slot suffix.", () => {
...
describe("INVARIANT: When a workspace path is produced, it SHALL be a valid absolute path.", () => {
...
describe('INVARIANT: When a workspace path is produced, it SHALL contain no ".." segments', () => {
