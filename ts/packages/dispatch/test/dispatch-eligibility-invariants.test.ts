...
describe("INVARIANT: When a dispatch is missing required fields, it SHALL be ineligible.", () => {
...
describe("INVARIANT: When a dispatch is in a terminal state, it SHALL be ineligible.", () => {
...
describe("INVARIANT: When a dispatch is in a non-active state, it SHALL be ineligible.", () => {
...
describe("INVARIANT: When a dispatch is not assigned to this worker, it SHALL be ineligible.", () => {
...
describe("INVARIANT: When an unstarted issue has a non-terminal blocker, it SHALL NOT be dispatched (blockers prevent starting).", () => {
...
describe("INVARIANT: When a started issue has open blockers, it SHALL be blocked.", () => {
  test("started issue with open blockers SHALL be ineligible", () => {
    fc.assert(
      fc.property(
        fc.array(
          fc.record({
  ...
  test("started issue with many open blockers SHALL be ineligible", () => {
    fc.assert(
...
describe("INVARIANT: When a terminal issue has open blockers, it SHALL be a no-op (blockers on terminal issues are no-op).", () => {
...
describe("INVARIANT: When an unstarted issue has only terminal blockers, it SHALL be eligible.", () => {
...
describe("INVARIANT: When a per-state concurrency cap is reached, the system SHALL not dispatch new work in that state.", () => {
...
describe("INVARIANT: When all ensemble slots are claimed, the dispatch SHALL be ineligible.", () => {
